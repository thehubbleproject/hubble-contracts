...
contract WithdrawManager {
    ...
    // function Withdraw(
    //     uint256 _batch_id,
    //     bytes calldata txsInLeft,
    //     bytes calldata withdrawTx,
    //     bytes calldata txsInRight,
    //     Types.CommitmentInclusionProof calldata commitmentMP,
    ...
    //     // Verify commitment exists in batch
    //     merkleUtils.verify(
    ...
    //         ),
    //         commitmentMP.commitment.pathToCommitment,
    //         commitmentMP.commit.siblings
    //     );

    //     // verify transaction exists in the batch
    //     require(
    //         commitmentMP.commitment.txHashCommitment ==
    //             keccak256(abi.encode(txsInLeft, withdrawTx, txsInRight)),
    //         "transactions do not match the commitment"
    //     );
